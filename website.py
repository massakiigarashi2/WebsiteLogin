...
if task1 == "Linguagem de Programação C++": 
    ...
    **OBSERVAÇÃO:** Instale a versão codeblocks-XX.XX ***mingw-setup.exe***. Pois ela inclui o compilador GCC/G++/GFortran e o GDB debugger necessários para a execução do seu programa 
    ...
    st.write("### Exemplo1:") 
    st.write("Crie uma variável chamada myNum do tipo inte atribua a ela o valor 5:")
    st.info("""
    ###### include <iostream>
    ###### **using namespace std;**
    ###### int main()
    ...
    st.write("Você também pode declarar uma variável sem atribuir o valor e atribuir o valor posteriormente:")
    st.info("""
    ###### include <iostream>
    ###### **using namespace std;**
    ###### int main()
    ...
    ###### }
    """)
    st.write("Mas é **IMPORTANTE** você saber também que, se você atribuir um novo valor a uma variável existente, ele substituirá o valor anterior:")
    st.info("""
    ###### include <iostream>
    ###### **using namespace std;**
    ###### int main()
